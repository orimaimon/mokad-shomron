...
| סטטיסטיקות | — | אנליטיקה, גרפים, מגמות אירועים ו-KPIs |
| ממשק מדווח | — | אפליקציית שטח PWA עם תמיכה בעבודה רציפה |
...
| Method | Path | תיאור |
|--------|------|-------|
| GET | `/api/analytics/kpi` | נתוני סיכום כלליים (אירועים החודש, אירועים פתוחים) |
| GET | `/api/analytics/trends` | ספירת אירועים יומית לאורך זמן (גרף מגמה) |
| GET | `/api/analytics/distribution` | פילוג אירועים לפי חומרה ולפי סוג עניין |
